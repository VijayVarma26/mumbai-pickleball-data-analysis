...
try:
    ...
    # Fetch the elements
    title = driver.find_elements(By.XPATH, title_xpath).text
    location = driver.find_elements(By.XPATH, location_xpath).text
    price = driver.find_elements(By.XPATH, price_xpath).text
